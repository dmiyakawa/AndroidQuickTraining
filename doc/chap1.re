...
==== ボタンに「イベントリスナー」を登録する (MainActivityDay1_5_ButtonWithEvents.java)
 ...
 ** 変数 ... 雰囲気だ！
 ** cast ... とりあえずスルーだ！
 ** Eclipseのショートカット ... お、おう！
 ** @<code>{OnClickListener} ... ボタン押されたら何か仕事するもの
 * とりあえず@<code>{Fragment}に「ボタンを押したよ」という連絡を受け取れるようにする
 ** 「ボタンを押したよ」 ... @<code>{OnClick} イベントと言う
 ** イベント ... 「何かあったよ」という話
 *** on click ... 「ボタンを押したとき」 (英語的な表現)
 *** 英語が全くわからないと結構つらいことが多いです
 * 今日はとりあえずログを出力してお茶を濁す
